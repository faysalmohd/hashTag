    ...
    return (
        <View style={[styles.container, { backgroundColor: !bgColor ? 'white' : 'black' }]}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
                ...
                {!isImage ? <TextInput multiline={true} value={caption} onChangeText={(caption) => { setCaption(caption) }} placeholder='Caption...' style={styles.caption}></TextInput> : ''}
            ...
            <TouchableHighlight style={styles.galleryBtn}>
                <FAB
                    ...
                    placement='right'
                    size='large'
                    icon={{ name: 'image', type: 'ionicon', size: 25, color: '#08FF08' }}
                    color="white"
                    onPress={pickImage}
                />
            </TouchableHighlight>
